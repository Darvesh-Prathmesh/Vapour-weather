...
export function WeatherHeader() {
  ...
  return (
    <header className="flex items-center justify-end w-full px-8 ">
      ...
      */}
      <div className="flex items-center gap-4 mr-[100px]">
        <button 
          className="w-16 h-16 rounded-full bg-gradient-to-br from-white/20 to-white/10 backdrop-blur-md flex items-center justify-center text-white hover:from-white/30 hover:to-white/20 transition-all duration-200 hover:scale-110 hover:shadow-lg hover:shadow-white/20 border border-white/20"
          aria-label="Add"
          title="Add"
        >
        ...
        <button 
          ...
          className={`w-16 h-16 rounded-full backdrop-blur-md flex items-center justify-center text-white transition-all duration-200 hover:scale-110 hover:shadow-lg border ${
        ...
        <button 
          ...
          className={`w-16 h-16 rounded-full backdrop-blur-md flex items-center justify-center text-white transition-all duration-200 hover:scale-110 hover:shadow-lg border relative ${
